c****************************************************************
	...
	subroutine conv_jdc(krad,gravite,delta,cp,ro,hp,taur,gradrad,gradad,
...
c       Amenagement pour faire des tests sur la valeur de V/A 
c       D. Cordier, Novembre 1999 (voir aussi cahier XIII p. 15v)
...
c	dgrad.. : derivees
	...
	if(.not. init)then	!vsal: V/Al
	 ...
	 print*, '****************************************'
	 print*, ' '
	 print*, 'Dans la routine de convection quelle'
	 print*, 'est la valeur de V/A a utiliser ?'
	 read(5,*) vsal
	 print*, ' '
	 print*, 'vsal= ', vsal, ' ok ?'
	 pause
