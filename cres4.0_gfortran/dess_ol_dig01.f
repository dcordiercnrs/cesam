c*************************************************************************
	...
	subroutine dess_ol_dig01(bp,q,n,qt,knot,chim,mc,nc,mct,knotc,teff,
...
c        ----------------------------------------
c         Aménagement pour avoir un cadre adapté en fonction de la masse
c         D.C., avril 2001.
	 if ( Mtot .le. 7.0d0 ) then
	    xmin3=4.5
	    xmax3=3.58
	    ymin3=2.0
	    ymax3=4.2
