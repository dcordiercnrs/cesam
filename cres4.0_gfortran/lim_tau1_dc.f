c******************************************************************
	...
	subroutine lim_tau1_dc(list,l,r,xchim,p,t,dpl,dpr,dtl,dtr,teff,rtot,
...
c Modif. D.C. Septembre 1999 : on rentre a la main la valeur initiale de la
c pression externe.
...
2	 format(//,1x,'LIMITE EXTERNE sans calcul d''atmosphere ',
	 ...
	 write(6,*) ' '
	 write(6,*) '-------- Estimation de la pression externe : -----'
	 write(6,*) '(valeur initialement dans le code : 1.d5)'
	 read(5,*) pprec
	 write(6,*) '-------- n. itera. max : -----------------'
	 read(5,*) ntour_max
	 write(6,*) '-------- precis. num.  : -----------------'
	 write(6,*) '(initialement 1.d-8)'
	 read(5,*) preci_num
c	 pprec=1.d5	!initialisation de la pression
	 n_atm=0
...
10	ntour=ntour+1
	...
	p=p-corr
	write(6,*)'p,corr,t,r,l,mtot,xchim(1),kap,dkapp'
	write(6,2000)p,corr,t,r,l,mtot,xchim(1),kap,dkapp
	if(abs(corr/p) .gt. preci_num)goto10
