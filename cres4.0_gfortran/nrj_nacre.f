c**************************************************************************
	...
	subroutine nrj_nacre(t,ro,comp,dcomp,jac,deriv,fait,
...
c
c                      Adaptation aux taux NACRE : avril 2003, Varsovie.
...
100	nchim=18	!nombre d'elements chimiques
	...
	call taux_nacre(.7d0,1.d7,1.d0,r,rt,rro,rx,rxx,q,qt,qro,qx,.false.)
...
200	if(t .lt. t_inf)then	!si t<t_inf
	...
	call taux_nacre(comp(1),t,ro,r,rt,rro,rx,rxx,q,qt,qro,qx,deriv)
...
300	if(t .ge. t_inf)then
	 if(fait .ne. 5)call taux_nacre(comp(1),t,ro,r,rt,
...
c	print*, 'epsilon(1) = ', epsilon(1), ' (TOT) '
c	print*, 'epsilon(2) = ', epsilon(2), ' (PP ) '
c	print*, 'epsilon(3) = ', epsilon(3), ' (CNO) '
c	print*, 'epsilon(4) = ', epsilon(4), ' (3a ) '
...
400	if(t .ge. t_inf)then
	 call taux_nacre(comp(1),t,ro,r,rt,rro,rx,rxx,q,qt,qro,qx,.false.)
