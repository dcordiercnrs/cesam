...
c**************************************************************************
	...
	subroutine ppcno3a_12e(t,ro,comp,dcomp,jac,deriv,fait,
...
c	on considere les elements de Z # CNO comme un element de masse atomique
c	28 et de charge 13, nom de cet element Ex (extra chemical)
...
100	nchim=13			!nombre total d'elements
...
c	table=.false.	!on utilise la tabulation des formules: reac_t_3
	...
	nucleo(11)=ao16
	nucleo(12)=ao17
	nucleo(13)=28		!element fictif representant le Z-CNO
...
c	abondances initiales en masse a partir de X: comp(1), et Y=comp(4)
	...
	do i=1,12
	 ...
	 ab_ini(13)=ab_ini(13)-ab_ini(i)	
	enddo
	comp(13)=ab_ini(13)/nucleo(13)
...
1	format(1x,' H : ',1pd10.3,3x,' H2 : ',1pd10.3,3x,' He3 : ',
     1	1pd10.3,3x,' He4 : ',1pd10.3,3x,' Li7 : ',1pd10.3,//,
     2	1x,' Be7 : ',1pd10.3,3x,' C12 : ',1pd10.3,3x,' C13 : ',
     3	1pd10.3,3x,' N14 : ',1pd10.3,3x,' N15 : ',1pd10.3,//,
     4	1x,' O16 : ',1pd10.3,3x,' O17 : ',1pd10.3,' Ex :',1pd10.3)
	write(2,*)' '
